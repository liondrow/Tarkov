 ...
 */
final class Version20240114184110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD team_name VARCHAR(255) DEFAULT NULL, ADD airsoft_team VARCHAR(255) DEFAULT NULL, ADD created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP team_name, DROP airsoft_team, DROP created_at');
    }
}
